...
@WebServlet(name = "StoreProductsDiscountsServlet", urlPatterns = {"/api/areas/stores/products/discounts"})
public class StoreProductsDiscountsServlet extends HttpServlet {
